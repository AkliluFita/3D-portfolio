...
const Cards = ({ item, index }) => {
  return (
    <div
      className="flex flex-col flex-[1]  gap-10 lg:flex-row rounded-lg border-gradient-primary"
      data-aos="fade-right"
    >
      <motion.div
        initial="hidden"
        ...
        className="flex-[1] flex flex-col gap-2 h-full lg:gap-4 p-4 bg-bg_secondary dark:bg-gray-900 rounded-lg"
      >
