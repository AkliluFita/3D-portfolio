...
const SlideText = ({ sideType }) => {
  return (
    <>
      {sideType === "left" ? (
        <motion.div
          className="absolute top-0 text-white  text-[3rem] font-bold opacity-50 whitespace-nowrap uppercase hidden lg:block w-1/2"
        ...
        <motion.div
          className="absolute bottom-0 text-white  text-[3rem] font-bold opacity-50 whitespace-nowrap uppercase  hidden lg:block  w-1/2"
