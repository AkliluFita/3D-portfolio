...
const Skill = () => {
  return (
    <div className=" bg-cover bg-center bg-no-repeat bg-aboutBack flex flex-col p-8 lg:h-[100vh] items-center  gap-4">
      ...
      <div className="flex flex-row flex-wrap items-center justify-between  gap-2 p-4  flex-[10] ">
        {skillData.map((item, index) => (
          <div
            key={index}
            className="  rounded-lg  w-[20rem] h-[10rem]  p-4  bg-[#018673]  bg-opacity-30"
          >
